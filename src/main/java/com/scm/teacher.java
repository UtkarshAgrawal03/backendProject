...
public class teacher extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		ob.setT_name(request.getParameter("tname"));
		ob.setT_gen(request.getParameter("tgen"));
		ob.setT_spec(request.getParameter("tspec"));
		...
		s1.save(ob);
		tx.commit();
		response.sendRedirect("Teacher_add.jsp");
	}
